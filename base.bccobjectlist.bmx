...
Type TBCCObjectList
	...
	End Rem
	Method Swap(list:TBCCObjectList)
		If Not list Then
			Return
		End If
	...
	End Rem
	Method Reversed:TBCCObjectList()
		Compact()
	...
	Method ObjectEnumerator:TBCCObjectListEnumerator()
		Local enumeration:TBCCObjectListEnumerator=New TBCCObjectListEnumerator
		enumeration.list = Self
		Return enumeration
	End Method

	Method ReverseEnumerator:TBCCObjectListReverseEnumerator()
		Local enumeration:TBCCObjectListReverseEnumerator = New TBCCObjectListReverseEnumerator
		enumeration.list = Self
	...
	End Rem
	Function FromArray:TBCCObjectList(arr:Object[])
		Local list:TBCCObjectList = New TBCCObjectList
...
Rem
bbdoc: Enumerator Object used by #TBCCObjectList in order to implement #Eachin support. 
End Rem
Type TBCCObjectListEnumerator

	Field list:TBCCObjectList
	Field index:Int = 0
...
End Rem
Type TBCCObjectListReverseEnumerator
	...
	Method ObjectEnumerator:TBCCObjectListReverseEnumerator()
		Return Self
	End Method
